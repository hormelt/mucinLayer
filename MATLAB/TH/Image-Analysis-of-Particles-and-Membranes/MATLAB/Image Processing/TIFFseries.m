...
%   Sept. 20, 2010: Use getnumfilelist.m to get information on files to load.
...
% last modified August 23, 2012 (very minor)
...
if ismultipage
    ...
    % define format string if outputing individual TIFFs
...
for k=frmin:Nskip:frmax,
    if (k==frmin)  % first frame
        ...
        if ismultipage
            ...
            FileName = [fbase, framestr, ext];  % using strcat(fbase, framestr, ext); causes problems if there are spaces at the end of fbase
